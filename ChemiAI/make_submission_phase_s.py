...
Запуск:
  python make_submission_phase_s.py cc50_clust_fe
"""
...
from run_phase_s import CANDIDATES, fit_phase_s
...
def build_test(variant: str, seed: int = 42) -> np.ndarray:
    ...
    clear_fold_cache()
    _, test = fit_phase_s(X, Xt, y, ext, blocks, seed, cfg)
    return test
...
def main() -> None:
    ...
    out = f"submission_phase_s_{args.variant}.csv"
