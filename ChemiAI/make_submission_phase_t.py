"""
Phase T сабмиты — cc50_cat_w tune на cb_fe.

Запуск:
  python make_submission_phase_t.py cc50_cat_w20
"""
...
from run_phase_t import CANDIDATES, fit_phase_t
...
def build_test(variant: str, seed: int = 42) -> np.ndarray:
    ...
    clear_fold_cache()
    _, test = fit_phase_t(X, Xt, y, ext, blocks, seed, cfg)
    return test
...
def main() -> None:
    ...
    out = f"submission_phase_t_{args.variant}.csv"
