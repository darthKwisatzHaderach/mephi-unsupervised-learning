"""
Узкая сетка mordred IC50 head поверх fr42_ic65.
Ref public: 273.40628 (mordred_w35).
"""
import time
...
def main() -> None:
    ...
    print("ref mord_w35:", {s: round(ref_scores[s], 2) for s in SEEDS})
    t0 = time.perf_counter()
    rows = []

    for mw in [0.32, 0.33, 0.35, 0.37, 0.38, 0.40]:
        for seed in SEEDS:
    ...
    sm.to_csv("phase_g_mord_tune.csv", index=False)
