"""
Phase Q сабмиты — CC50 transductive fe tuning.

Запуск:
  python make_submission_phase_q.py cc50_fe_v1v2
"""
...
from run_phase_q import CANDIDATES, fit_phase_q
...
def build_test(variant: str, seed: int = 42) -> np.ndarray:
    ...
    clear_fold_cache()
    _, test = fit_phase_q(X, Xt, y, ext, blocks, seed, cfg)
    return test
...
def main() -> None:
    ...
    out = f"submission_phase_q_{args.variant}.csv"
